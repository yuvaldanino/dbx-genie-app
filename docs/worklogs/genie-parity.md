...
| 5 | **Context depth 1: no degradation** (`ab_fresh` vs `ab_resumed`: same 36 rows, semantically identical SQL). Synthetic 7-deep context test running (`ab_long_context`) | ab_*.json | Long-context pollution judgement pending |
